...
?>
	...
	<div class="row">
		<div class="span10 app-info" id="app<?php echo $appt->id?>">
			<div class="row appointment">
				<div class="span1">
					<img src="<?php echo $doc->photo; ?>"/>
				</div>
			...
			<div class="row app-control" >
				<div class="span9">
					<div>
						<span ><a href="approve.php?pid=<?php echo $appt->id; ?>" id="<?php echo $appt->id; ?>" class="pstponelink"><input type="button" class="postpone btn btn-success btn-mini zero-radius"value="Approve"id="<?php echo $appt->id; ?>"></a></span>
						<span ><a id ="<?php echo $appt->id; ?>"  href="postpone.php?pid=<?php echo $appt->id; ?>" class="pstponelink" ><input type="button" class="postpone btn btn-primary btn-mini zero-radius"value="PostPone"id="<?php echo $appt->id; ?>"></a></span>
						<span><a href="cancel.php?ed=<?php echo $appt->id; ?>" class="cancellink"><input type="button" class="btn btn-danger btn-mini zero-radius"value="Cancel" id="<?php echo $appt->id; ?>"></a></span>
						<button type="button" class="close">&times;</button>
					</div>
				</div>
