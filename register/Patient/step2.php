...
<div style="overflow-y:scroll; height:260px; margin-top:3px;">
	...
	$result = mysql_query("SELECT a.name, a.speciality , a.photo,a.id FROM doctor a, hospital_doctor b where a.id=b.doctor_id and b.status='approved' group by a.id")or die(mysql_error());
