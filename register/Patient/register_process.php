...
$id=$obj->addNewPatient($_POST['user_name'],$_POST['user_email'],$_POST['year']."-".$_POST['month']."-".$_POST['day'],$_POST['gender'],$_POST['condition'],$_SESSION['picture'],$_SESSION['refresh'],$folder);
