...
<div class="controls">
<input type="text" class="input-xlarge" id="user_email" disabled="disabled" name="user_email" value="<?php echo $_SESSION[email] ?>" rel="popover" data-content="What’s your email address?" data-original-title="Email">
</div>
</div>
