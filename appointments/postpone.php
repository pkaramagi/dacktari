...
$start = substr($result->starttime,0,19);
$end = substr($result->endtime,0,19);
?> 
<html>    
    <head>
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
                ...
                <form class="form-horizontal" action="
				 <?php if($_SESSION['type']=="patient"){echo 'addappointment.php?db_option=cancel';}
					else{echo "approve.php?db_option=postpone"; } ?>"
				method="post">
					<div class="control-group">
						<label class="control-label" for="inputStartTime" >StartTime</label>
						<div class="controls">
							<input type="datetime" name="starttime" class="input-xlarge focused"  id="starttime" placeholder="starttime" value="<?php echo $start; ?>">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="inputEmail">EndTime</label>
						<div class="controls">
							<input type="datetime" name="endtime" class="input-xlarge focused" id="endtime" placeholder="endtime" value="<?php echo $end; ?>">
						</div>
					</div>
					<div class="control-group">
