		...
		<div class="span10 app-info">
			<div class="row appointment">
				...
				<div class="span7">
					<p><strong><?php echo $appt->title; ?> </strong></p>
					<p><strong><?php echo $appt->description; ?> </strong></p>
					<p><?php echo date('D,F jS g:i a', strtotime(substr(str_replace('T',' ',$appt->starttime),0,16 ))); ?> at <a href="getdirection.php?location=<?php echo $appt->location ?>" title="getdirections" class="directions" > <?php echo $appt->location ?></a></p>
				</div>
			</div>
			...
			<div class="row app-control" >
				<div class="span9">
					<div>
						<span ><a href="<?php echo $location; ?>/postpone.php?pid=<?php echo $appt->id; ?>"  class="pstponelink" ><input type="button" class="postpone btn btn-primary btn-mini zero-radius"value="PostPone"id="<?php echo $appt->id; ?>"></a></span>
						<span><a href="<?php echo $location; ?>/cancel.php?ed=<?php echo $appt->id; ?>" class="cancellink"><input type="button" class="btn btn-danger btn-mini zero-radius"value="Cancel" id="<?php echo $appt->id; ?>"></a></span>
						<button type="button" class="close">&times;</button>
					</div>
				</div>
